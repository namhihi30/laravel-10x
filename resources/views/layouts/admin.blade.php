...
<head>
    ...
    <link href="{{ asset('admins') }}/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <link href="{{ asset('admins') }}/css/plugins/timeline/timeline.css" rel="stylesheet">
...
<div id="wrapper">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="#"><i class="fa fa-user fa-fw"></i> {{ Auth::check() ? Auth::user()->name : '' }}</a>
                    </li>
    ...
    {{--                            </li>--}}
    {{--                            <li>--}}
    {{--                                <a href="{{ route('admin.posts.add') }}">Thêm mới</a>--}}
    {{--                            </li>--}}
    {{--                        </ul>--}}
                        <!-- /.nav-second-level -->
                    </li> <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Nhóm người dùng<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('admin.groups.index') }}">Danh sách</a>
                            </li>
                            <li>
...
<script src="{{ asset('admins') }}/js/jquery-1.10.2.js"></script>
...
<script src="{{ asset('admins') }}/js/plugins/morris/raphael-2.1.0.min.js"></script>
<script src="{{ asset('admins') }}/js/plugins/morris/morris.js"></script>

<!-- SB Admin Scripts - Include with every page -->
<script src="{{ asset('admins') }}/js/sb-admin.js"></script>

<!-- Page-Level Demo Scripts - Dashboard - Use for reference -->
<script src="{{ asset('admins') }}/js/demo/dashboard-demo.js"></script>
